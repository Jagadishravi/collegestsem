<%-- 
    Document   : winnerresult
    Created on : Aug 27, 2022, 12:07:23 AM
    Author     : Jagadeesh
--%>
...
<html>
    ...
    <body>
        ...
        <center><table border="1" style="font-size: 20px; color: black; background-color:lightblue;">
            <tr><th>POSITION</th><th>STUDENT</th><th>WINNER NAME</th><th>VOTE COUNTS</th><th>COLLEGEID</th>
            </tr>       <%
       rst=stmt.executeQuery("select * from result where cid='"+cid+"'");
       while(rst.next()){
           out.println("<tr><td>"+rst.getString("position")+"</td><td>"+rst.getString("student")+"</td><td>"+rst.getString("wname")+"</td><td>"+rst.getString("counts")+"</td><td>"+rst.getString("cid")+"</td></tr>");
         }
%>
        </table></center>
        </section>
