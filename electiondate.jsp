<%-- 
    ...
    Created on : Aug 1, 2022, 9:02:25 PM
    Author     : Jagadeesh
--%>
    ...
    <body>
        <section>
         ...
         <div class="navbar">
             ...
             <li><a href="viewelectiondates.jsp">VIEW ELECTIONS</a></li>
        ...
        <div class="outerdiv">
         <div class="innerdiv">
             ...
             <form method="post" action="electiondatecheck.jsp">
                 <h1>ELECTION DATE<h1>
          ...
          <p><select name="nominee" class="intpt">
            ...
            <p><input type="date" placeholder="DD/MM/YY" name="date"  class="intpt" ></p>
            <p><input type="text" placeholder="college ID" name="cid"  class="intpt" readonly value="<%=rst.getString("collegeid")%>"></p>
            <div class="bot">
